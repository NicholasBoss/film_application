class feature:
    ...
    def update_movie_feature(self, feature_id, movie_id, new_movie_id, new_feature_id):
        ...
        self.db_cursor.execute('UPDATE movie_feature SET movie_id = %s, feature_id = %s WHERE movie_feature_id = %s', (new_movie_id, new_feature_id, result[0]))
        self.mydb.commit()
        print(self.db_cursor.rowcount, 'record updated.')
        print('\n')
